...
export const SkillsSection: React.FC<SkillsSectionProps> = ({ skillsHeading }) => {
  const [segments, setSegments] = React.useState(38);
  React.useEffect(() => {
    const updateSegments = () => {
      setSegments(window.innerWidth > 768 ? 38 : 52);
    };
    updateSegments();
